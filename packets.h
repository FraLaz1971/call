...
struct DDSheader {
  ...
  unsigned short usec_msb;
  unsigned short usec_lsb;
  unsigned int pkt_len;
  unsigned short gr_st_id;
  unsigned short vc_id;
  unsigned char lse_id;
...
// following words
    unsigned short int  data[NMAX-6];// data field
